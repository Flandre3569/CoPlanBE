...
const { register, login, success, setProfile, queryProfile, changeAvatar } = require('../controller/user');
...
userRouter.post('/avatarUpload', authVerify, upload.single('file'), changeAvatar); // 上传头像到oss
